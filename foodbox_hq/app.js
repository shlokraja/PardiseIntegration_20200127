...
var fv_Preprinted = require('./routes/fv_Preprinted'); // new for Preprinted
...
var sbu = require('./routes/sbu_report');
...
var paradise_report = require('./routes/paradise_report');
var paradise_detailed_report = require('./routes/paradise_detail_report');
...
//for over all sbu report
// new cronJob('*/5 * * * *', function () {
//   sbu.genOverAllReport();
// },
//   true,
//   'Asia/Kolkata'
// );
// //for outlet wise report
// // */5 * * * *
// new cronJob('*/5 * * * *', function () {
//   sbu.genOutletwiseReport();
// },
//   true,
//   'Asia/Kolkata'
// );
...
app.use(session({
  secret: 'atchayamsecretreports1234',
...
app.use('/fv_Preprinted', fv_Preprinted);
...
app.use('/users', users);
app.use('/paradise_report',paradise_report);
app.use('/paradise_detailed_report',paradise_detailed_report);
