...
function check_volume_plan_mail() {
    console.log("Calling Check_volume_plan_mail",conString);
            ...
            function (query_err, restaurant_name_result) {
			    ...
			    //sleep(3000);
                            transporter.sendMail(mailOptions, function (error, info) {
                                if (error) {
                                    console.log("send_pivot_mail : Error sending mail in check volume plan");
                ...
                if (result.rows.length <= 0) {
                    ...
                    Object.keys(restaurant_data).map(function (key) {
                        ...
                        get_city_for_restaurant(restaurant_id, function (err, city_response) {
                            ...
                            //sleep(1000);
//To be uncommented 11-11-2019 jaga...
                           /* transporter.sendMail(mailOptions, function (error, info) {
                                if (error) {
                                    console.log("Error in check volume plan mail");
                                    return console.log(error);
                                    //  send_pivot_mail(vp_avail_date, restaurant_id, subject_to_mail, city_response,condition_string); //to be commented
                                }
                                console.log('Message sent: ' + info.response);
...
console.log("########################","Updating Volume Plan:"+restaurant_id+":"+condition_string);
