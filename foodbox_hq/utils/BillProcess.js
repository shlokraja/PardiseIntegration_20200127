...
function ProcessSales(data) {
    ...
    if (data.bill_time == check_date) {
      ...
      VALUES($1, now(), $2, $3, $4, $5, $6,$7,$8,$9) \
            ...
            config.query(query, query_array,
                        ...
                        if (result != null && result.rows != null && result.rows.length > 0) {
                            ...
                            async.map(_.keys(food_details),
                                function (item_id, map_callback) {
                                    ...
                                    if (typeof outlet_order_id != "undefined") {
                                        bill_items_query = 'INSERT INTO bill_items \
                        VALUES ($1, $2, $3, $4, get_dispense_status($3)::dispense_status,$5,$6,$7)';
                                        bill_items_query_array = [sales_order_id,
                                            bill_no, item_id, food_details[item_id], mobile_num, is_mobile_order, outlet_order_id
                                        ];
                                    } else {
                                        bill_items_query = 'INSERT INTO bill_items \
                        VALUES ($1, $2, $3, $4, get_dispense_status($3)::dispense_status,$5,$6)';
                                        bill_items_query_array = [sales_order_id,
                                            bill_no, item_id, food_details[item_id], mobile_num, is_mobile_order
                                        ];
                                    }
                                    //                         config.query('INSERT INTO bill_items \
                                    //   VALUES ($1, $2, $3, $4, $5,$6,$7)', [sales_order_id,
                                    //                             bill_no, item_id, food_details[item_id], 'delivered', mobile_num, is_mobile_order
                                    //                         ], map_callback);
