...
function checkIncomingPO() {
    ...
    var GET_MENU_PLANS = '/outlet/get_menu_bands/';
        ...
        .then(function() {
            async.waterfall([
                    ...
                    function(lastloaddata, callback) {
                        ...
                        request(hq_url + GET_MENU_PLANS + outlet_id, { timeout: 30000 },
...
function send_reconcile_data_to_HQ(reconcile_data, callback) {
	...
	if(po_main_data[0] == undefined){
	   return;
	}

	console.log("po_main_data:::::",po_main_data)
